...
export const translations = {
  da: {
    ...
    autoDateHint: 'Hvis undertitlen er tom, bruges automatisk måned/år.',
    layout: 'Format',
    regularLayout: 'Normal',
    ...
    pages: 'Sider',
    noSelection: 'Vælg en medarbejder først. Detaljer kan kun redigeres, når en medarbejder er valgt.',
    ...
    delete: 'Slet',
    language: 'Sprog',
    addSectionFirst: 'Vælg eller tilføj en sektion først. Medarbejdere og billeder kan kun redigeres, når en sektion er valgt.',
  ...
  en: {
    ...
    autoDateHint: 'If the subtitle is empty, automatic month/year is used.',
    layout: 'Format',
    ...
    praktikant: 'Intern',
    pages: 'Pages',
    noSelection: 'Select a staff member first. Details can only be edited when a staff member is selected.',
    ...
    delete: 'Delete',
    language: 'Language',
    addSectionFirst: 'Select or add a section first. Staff and images can only be edited when a section is selected.',
